...
flights_path = "OutputFlights/flights_paris_regional_future.csv"
meteo_path = "OutputDataMeteo/meteo_aeroports_future.csv"
output_path = "FlightsAndMeteo_future.csv"
