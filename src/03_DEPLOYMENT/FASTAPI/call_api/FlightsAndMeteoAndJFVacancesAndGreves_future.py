...
# Fichiers d'entrée
flights_path = "FlightsAndMeteoAndJFVacances_future.csv"
greves_path = "OutputDataGreves/greve_aeroports_future.csv"
output_path = "FlightsAndMeteoAndJFVacancesAndGreves_future.csv"
